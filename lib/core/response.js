...
const ParamsL = R.lensPath(['request', 'value', 'params']);
const QueryL = R.lensPath(['request', 'value', 'query']);
...
const getParams = R.chain(R.view(ParamsL));
const getQuery = R.chain(R.view(QueryL));
